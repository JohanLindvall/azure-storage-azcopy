...
func doDeleteFile(jptm IJobPartTransferMgr) {
	...
	srcFileClient := common.CreateShareFileClient(source, jptm.SourceCredentialInfo(), jptm.CredentialOpOptions(), jptm.ClientOptions())
...
func doDeleteFolder(ctx context.Context, folder string, jptm IJobPartTransferMgr, logger common.ILogger) bool {
	...
	srcDirClient := common.CreateShareDirectoryClient(folder, jptm.SourceCredentialInfo(), jptm.CredentialOpOptions(), jptm.ClientOptions())
	helper := &azureFileSenderBase{}
